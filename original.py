...
class sample_generator(nn.Module):
    def __init__(self, instrument_size):
        ...
        self.h1      = nn.ConvTranspose2d(in_channels=157, out_channels=128, kernel_size=(2,1), stride=(2,2))
        self.h2      = nn.ConvTranspose2d(in_channels=157, out_channels=128, kernel_size=(2,1), stride=(2,2))
        self.h3      = nn.ConvTranspose2d(in_channels=157, out_channels=128, kernel_size=(2,1), stride=(2,2))
        self.h4      = nn.ConvTranspose2d(in_channels=157, out_channels=1, kernel_size=(1,128), stride=(1,2))
